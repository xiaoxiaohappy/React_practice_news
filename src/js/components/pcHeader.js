...
import {
    Menu, Icon,
    Tabs, meaaage, Form,Modal, Input, Button, Checkbox
} from 'antd';
            ...
            <header>
                <Row>
                    ...
                    <Col span={16}>
                        ...
                        <Modal title="用户中心" wrapClassName="vertical-center-moal" visible={this.state.modalVisible} onCancel={()=>this.setModalVisible(false)}  onOk={()=>this.setModalVisible(false)} okText="关闭">
                            <FormItem label="账户">
